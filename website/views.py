...
def Request():
    ...
    if request.method == 'POST':
        ...
        new_entry = Plasma(name=form.name.data, email=form.email.data, contact_no=form.contact_no.data, blood_group=form.blood_group.data, date_details=form.date_details.data, address=form.address.data, details=form.details.data)
